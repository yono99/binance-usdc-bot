...
def append(row: dict, path: Path | str = DECISION_LOG) -> None:
...
def read_all(path: Path | str = DECISION_LOG) -> list[dict]:
...
def recent(n: int = 20, path: Path | str = DECISION_LOG) -> list[dict]:
